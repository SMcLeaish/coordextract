"""This module provides functionality for parsing GPX files to extract
geographical data, including waypoints, trackpoints, and routepoints. It
supports both synchronous and asynchronous operations to accommodate
