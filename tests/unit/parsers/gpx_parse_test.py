...
def mock_invalid_gpx_point() -> etree._Element:
    ...
    return point
def test_parse_point_invalid(mock_invalid_gpx_point: \
                             etree._Element, caplog: pytest.LogCaptureFixture) -> None:
    """
    ...
    with caplog.at_level(logging.ERROR):
        ...
        assert result == (math.nan, math.nan), "Should return NaN for invalid coordinates"
